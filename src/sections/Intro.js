    ...
    <div className="section">
      <div className="relative flex">
              ...
              {i18n.language === "en" && (
                <div>
                  <p>
                    ...
                    Phasellus accumsan dui id ligula iaculis finibus. Nulla vel
                    sapien eget leo fringilla imperdiet. Aenean urna mi, tempor
                    sit amet fermentum non, facilisis a lorem. Vivamus
                  ...
                  <p>
                    ...
                    consectetur adipiscing elit. Sed in massa lorem. In et odio
                    augue. Orci varius natoque penatibus et magnis dis
                    parturient montes, nascetur ridiculus mus. Praesent ac urna
                    pulvinar, scelerisque sapien et, convallis lorem. In urna
                    mauris, eleifend at nisl eget, mollis pellentesque dolor.
                    Maecenas lacus lacus, feugiat quis velit varius:{" "}
                    <a href="https://google.com">www.egestas.com</a> pretium
                    orci. Maecenas imperdiet commodo gravida. Pellentesque justo
                    justo, venenatis ut sem ac, tincidunt venenatis ex.
                  </p>
                  <p>
                    ...
                    tincidunt ullamcorper. Cras convallis elit nibh, ac placerat
                    est fringilla a. Aliquam metus nisl, sodales tempus lacinia
                    eget, facilisis vitae tortor. Nunc porttitor aliquet erat at
                    tempor. Nunc sed consectetur massa. Integer semper ligula in
                    nulla rutrum, bibendum suscipit arcu sollicitudin. Fusce
                    efficitur vitae magna sit amet sollicitudin. Ut arcu dolor,
                    scelerisque non hendrerit non, mattis eget elit. Vestibulum
                    imperdiet nunc at diam convallis, quis pretium est viverra.
                    Vestibulum lobortis, nisi vitae facilisis tempor, magna
                    ipsum posuere ex, quis accumsan elit nibh non orci. Aenean
                    at dignissim erat, a vulputate lacus.
                  </p>
                </div>
              )}
            </div>
        ...
        <div className="flex max-w-md flex-col bg-main-dark text-white">
          <div className="bg-neutral-800 px-20 py-16 text-center">
            <img src={concave} alt="" className="mx-auto max-w-[70%]" />
          </div>
            ...
            {i18n.language == "en" && (
              <div>
                <p>
                  ...
                  nulla, commodo tempor laoreet ut, scelerisque eu
                  ...
                  tincidunt viverra odio.In tempus molestie lorem, at efficitur
                  tortor tincidunt vitae.In ultrices lobortis
