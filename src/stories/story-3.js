...
export const story3 = {
  ...
  content: {
    en: (
      <div>
        <p>
          Enam belas tahun silam, tepat awal tahun 2007 luka itu mulai saya rasakan akibat kesetiaan yang lepas dari ikatan, badai rumah tangga mengubah bahagia menjadi gulita. Saya yang kala itu dalam keadaan yang masih bingung, gelisah, tak tahu harus kemana melangkah dengan membawa kedua anak saya.
          <br />
          Namun, secercah cahaya datang saat hidup mulai temaram. Saat itu saya dipertemukan dengan organisasi perempuan binaan Yayasan Sapa yang bernama Bale Istri. Pertama kali bergabung, masih ada keraguan. Akan tetapi, seiring berjalannya waktu, saya paham dan sadar bahwa saya perlu bersosialisasi dengan masyarakat sekitar supaya bisa beradaptasi dengan keadaan, mandiri secara finansial, tanpa membebani keluarga besar.
        </p>
        ...
        <p>Saya yang dulu sangat pemalu tidak percaya diri, begitu pula dengan ibu-ibu lainnya mulai merasakan ada perubahan. Perlahan kami semua belajar mendampingi kasus, dan advokasi ke pemerintah setempat, kemudian bernegosiasi dengan pasangannya atau keluarganya. Bersama empat orang teman saya yang hampir sebaya, kami mulai sibuk dengan pendampingan kasus, dan kegiatan lainnya.</p>
        <p>
          Tahun 2020 program <em>Safe and Fair</em> hadir dan saya mulai mencoba mendampingi kasus pekerja migran dengan berbekal ilmu seadanya. Kesempatan diundang ke istana negara saya dapatkan dalam tahun yang sama dalam rangka Hari Perempuan Sedunia.
        </p>
        <p>
          <blockquote>
            <p>
        ...
        <p>
          Program <em>Safe and Fair</em> yang fokus di pendampingan kasus Pekerja Migran Indonesia (PMI) cukup membantu kami dalam peningkatan kapasitas kami sebagai pendamping. Saat ini, relawan pendamping kasus mulai bertambah yang semula hanya 5 orang, menjadi 20 orang dari 8 wilayah desa binaan Bale Istri. Beberapa penyintas atau purna PMI pun turut bergabung di Komunitas Bale Istri
        </p>
        <p>
          Dengan mendampingi kasus, saya mulai merasa lebih kuat. Dengan mendengarkan cerita luka dari teman-teman penyintas yang lain, membuat saya merasa tidak sendiri. Dengan berkumpul bersama di Komunitas Bale Istri, saya merasa dihargai, dibutuhkan, dan saling menguatkan satu sama lain.
          <br />
          Bagi saya, ada kepuasan tersendiri apabila kasus yang saya dampingi berjalan sesuai dengan harapan korban, diputus pengadilan, dan korban merasa tertolong.
        </p>
        <p>
