...
export const story3 = {
  ...
  name: "Sugih Hartini",
  title: {
    en: "Transformasi Luka menjadi Kekuatan",
  ...
  content: {
    en: (
      <div>
        <p>
          Enam belas tahun silam, tepat awal tahun 2007 luka itu mulai saya
          rasakan akibat kesetiaan yang lepas dari ikatan, badai rumah tangga
          mengubah bahagia menjadi gulita. Saya yang kala itu dalam keadaan yang
          masih bingung, gelisah, tak tahu harus kemana melangkah dengan membawa
          kedua anak saya.
          <br />
          Namun, secercah cahaya datang saat hidup mulai temaram. Saat itu saya
          dipertemukan dengan organisasi perempuan binaan Yayasan Sapa yang
          bernama Bale Istri. Pertama kali bergabung, masih ada keraguan. Akan
          tetapi, seiring berjalannya waktu, saya paham dan sadar bahwa saya
          perlu bersosialisasi dengan masyarakat sekitar supaya bisa beradaptasi
          dengan keadaan, mandiri secara finansial, tanpa membebani keluarga
          besar.
        </p>
        <p>
          Di sebuah saung berukuran 3x4 meter, di tengah sawah yang dihuni
        ...
        <p>
          ...
          (JRPK) yang dibentuk oleh Yayasan Sapa. Bersama teman-teman, saya
          sering mengikuti pelatihan-pelatihan yang diselenggarakan oleh Yayasan
          Sapa untuk menunjang pengetahuan kami dalam pendampingan kasus
        ...
        <p>
          ...
          mendengarkan cerita luka dari teman-teman penyintas yang lain, membuat
          saya merasa tidak sendiri. Dengan berkumpul bersama di Komunitas Bale
          Istri, saya merasa dihargai, dibutuhkan, dan saling menguatkan satu
          sama lain.
          <br />
          Bagi saya, ada kepuasan tersendiri apabila kasus yang saya dampingi
          berjalan sesuai dengan harapan korban, diputus pengadilan, dan korban
          merasa tertolong.
        </p>
        <p>
        ...
        <p>
          Doa mereka membuat saya semakin merasa bersyukur, ternyata masih bisa
          menebar manfaat bagi banyak orang. Hingga saat ini, banyak korban yang
          sudah saya damping. Saya pun masih tetap berwirausaha di sela-sela
          kesibukan saya dengan usaha keripik yang diberi nama "BAIS SNACK".
          Melalui usaha kecil tersebut, saya juga bisa membuat anak-anak
          mendapatkan pendidikan yang lebih tinggi, putri sulung saya yang telah
          berhasil meraih gelar sarjana di Universitas Pendidikan Indonesia.
