...
export const story3 = {
  ...
  name: "Sugih Hartini",
  title: {
    en: "Transforming Wounds into Strength",
    id: "Transformasi Luka menjadi Kekuatan",
  },
  content: {
    en: (
      <div>
        <p>Sixteen years ago, at the start of 2007, I began to feel the wounds caused by untied loyalty, a household storm that turned happiness into darkness. At that time, I was still confused, anxious, and did not know where to go with my two children.</p>
        <p>However, just as my life began to dim, along came a glimmer of light. At that time, I encountered a women&rsquo;s organization supported by SAPA Foundation called Bale Istri. When I first joined, I still had doubts about it. However, as time went by, I understood and realized that I needed to socialize with the surrounding community so that I could adapt to my situation and become financially independent, without burdening my extended family.</p>
        <p>In a hut measuring 3 by 4 meters, in the middle of a rice field inhabited by several families, I and Bale Istri members who came from various backgrounds, including housewives, Family Welfare Movement (PKK) cadres, and integrated health centre cadres, gathered once a week. In this hut, we learned together about women&rsquo;s issues such as domestic violence, sexual violence, reproductive health, as well as entrepreneurship.</p>
        <p>
          <strong>Starting a Business</strong>
        </p>
        <p>With the help of my family and three children, I started to become independent in order to support myself and my family. In 2013, I started a business selling snacks with the help of capital from the social service, amounting to Rp500,000.</p>
        <p>In 2014, I joined the Case Assistance Volunteer Network (JRPK) team formed by SAPA Foundation. Together with my friends, I often attended training organized by SAPA Foundation to build our knowledge in assisting cases of violence against women.</p>
        <p>I was once very shy and had no confidence just as many other women did, but then I started to feel a change. Slowly we all learned to accompany the case, advocate the local government, then negotiate with the partner or family. With four of my friends who were almost the same age, we became occupied with case assistance and other activities. In 2019, I was recruited by SAPA Institute as a case assistance coordinator, and was required to come to the office three days every week. In a neatly arranged 2 by 3 meter room, I would receive case complaints or conduct counseling. In addition to this, I was provided with a device to create a case complaint hotline.</p>
        <p>In 2020, the Safe and Fair programme arrived, and I started trying to assist migrant worker cases. That year, I was also invited to the state palace on the occasion of International Women&rsquo;s Day. Myself and 15 other women from various provinces had the opportunity to chat directly with President Joko Widodo. The Safe and Fair programme, which focuses on assisting cases of Indonesian migrant workers (PMI), was quite helpful for us in increasing our capacity as assistants. Case assistance volunteers have also started increasing, from five people to 20 across eight villages assisted by Bale Istri. Several survivors or former migrant workers have also joined the Bale Istri community.</p>
        <p>By accompanying cases, I have started to feel stronger. Listening to stories about the wounds of other survivors has made me feel that I am not alone.&nbsp;</p>
        <p>
          <blockquote>By gathering together in the Bale Istri community, I feel appreciated, needed, and that we are mutually strengthening each other. For me, I found great satisfaction when a case I accompanied went according to the victim&rsquo;s expectations, was decided by the court, and the victim felt helped.</blockquote>
        </p>
        <p>
          &ldquo;<em>Bu, hatur nuhun tos dibantu. Ibu dan keluarga sing sehat, putra putri na saroleh... arageung milikna, aamiin..." </em>(Ma&rsquo;am, thank you very much for helping me. I wish you and your family good health, and that your children grow up to be upstanding, prosperous people.)&nbsp;
        </p>
        <p>
          <strong>Success in the Combination of Prayer and Effort</strong>
        </p>
        <p>The prayers of the survivors have made me feel even more grateful, and it turns out they can still spread benefits to many people. To date, I have assisted many victims. I am still an entrepreneur and have a busy schedule with my snack business called &ldquo;BAIS SNACK&rdquo;. Through this small business, I have been able to enroll my children in higher education. My eldest daughter has successfully obtained a bachelor&rsquo;s degree from the Indonesian University of Education. I hope that I and my case assistance friends will remain enthusiastic, not give up, continue to be a friend to those who are hurt, and to find strength in the wounds.</p>
        <p>
          <em>Sugih Hartini is a survivor of violence who has transformed into a victim support person. Currently, she works for SAPA Foundation and is active in Bale Istri.</em>
        </p>
      </div>
    ),
    id: (
