                ...
                <div className=" relative z-10 mx-auto h-full min-h-screen w-full">
                  ...
                  <div className="relative">
                    <img
                      ...
                      alt=""
                    />
                    <div className="absolute bottom-0 left-0 mx-auto w-full bg-opacity-50 bg-gradient-to-b from-transparent to-black/50 py-6 pb-4 md:px-10 md:py-10 md:pb-6 lg:pb-10">
                  ...
                  <div className="flex flex-col gap-3 bg-black bg-opacity-60 px-6 py-4 text-xs text-white md:hidden">
                    <div className="">
                    ...
                    <div>Photo: UN Women/M R Hasan, Illustration: PORTRAY</div>
                  </div>
